...
Here we explore the occurrence of substorms over an entire year and attempt to quantify their frequency, 

\begin{figure}[!ht]
  \centering
  \includegraphics[width=12cm]{../images/2003_substorm_hist.png}
  \caption{Looking at number of substorms in each month.}
  \label{fig:lowlim}
\end{figure}
