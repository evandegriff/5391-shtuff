...
% left-justify title so it doesn't complain about overfull hboxes
\begin{flushleft}
  % begin a subsection
  \subsection{Defining Radiation Belt Enhancement Events Based on Probability Distributions}
% done with left-justifying
\end{flushleft}
...
% also a fun thing I learned: using a backslash after \LaTeX (e.g. \LaTeX\) puts a nice space after LaTeX so it's weird formatting doesn't squish other words
