...
\begin{table}[ht!]
  ...
  % label so we can reference table
  \label{tab:1}
...
\begin{figure}[ht!]
  ...
  \begin{tikzpicture}
    ...
    \begin{feynman}
      ...
      % enter diagram environment
      \diagram* {
        % specify all edges, provide labels and particle types
...
% leave the document environment
\end{document}
