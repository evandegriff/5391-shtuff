...
# set plot title
ax.set_title('Number of Gens to Reach Target Phrase as Fn of Generation Size')
# create file output name
outfile_name = out_dir + 'gens_size_mean_10_25_to_200.png'
# save the plot
